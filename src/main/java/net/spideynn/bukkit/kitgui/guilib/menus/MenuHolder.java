...
/**
 * Allows you to set the {@link net.spideynn.bukkit.kitgui.guilib.menus.ItemMenu} that created the Inventory as the Inventory's holder.
 */
public class MenuHolder implements InventoryHolder {
    ...
    /**
     * Gets the {@link net.spideynn.bukkit.kitgui.guilib.menus.ItemMenu} holding the Inventory.
     *
     * @return The {@link net.spideynn.bukkit.kitgui.guilib.menus.ItemMenu} holding the Inventory.
     */
