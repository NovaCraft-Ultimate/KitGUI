...
/**
 * A {@link net.spideynn.bukkit.kitgui.guilib.items.StaticMenuItem} that opens the {@link net.spideynn.bukkit.kitgui.guilib.menus.ItemMenu}'s parent menu if it exists.
 */
