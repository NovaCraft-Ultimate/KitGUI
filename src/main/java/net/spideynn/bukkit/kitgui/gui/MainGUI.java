...
public class MainGUI extends ItemMenu {
    ...
    public MainGUI(JavaPlugin plugin, Player opener) {
        ...
        this.setItem(16, new SubMenuItem(Main.getInstance(), ChatColor.DARK_PURPLE + "Friends [BETA]", new ItemStack(Material.ENCHANTED_BOOK), new FriendsMenu(Main.getInstance(), this, opener)));
        this.fillEmptySlots();
    }
}